...
Start by running `uname -s`. If output is not `Darwin`: say "This is the Mac version. Grab the Linux or Windows version from https://github.com/blueshirtprogrammer/-goodlock-ai-trading-desk" and stop. If `Darwin`: say "macOS confirmed. Let's build your firm." and proceed.
